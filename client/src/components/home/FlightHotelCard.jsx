      ...
      <Container className={'max-w-[1280px] mx-auto'}>
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-8">
          {cards.map((card) => (
            <div
              key={card.id}
              className="relative w-full lg:w-1/2 h-[400px] sm:h-[480px] md:h-[520px] lg:h-[559px] rounded-xl sm:rounded-2xl overflow-hidden group cursor-pointer shadow-lg hover:shadow-xl transition-all duration-300"
            >
              {/* Background Image */}
        ...
        <div className="mt-8 sm:mt-12 lg:mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-8 mt-6 sm:mt-8">
            <div className="text-center w-full sm:w-[calc(50%-16px)] lg:w-[calc(33.333%-22px)] min-w-[250px] max-w-[350px]">
